...
//        for (Employee employee : employees) {
//            switch (currentHoliday) {
//                case NONE -> System.out.println(employee.getName() + " " + Holidays.NONE.getRussianHolidaysTitle());
//                case NEW_YEAR -> System.out.println(employee.getName() + " " + Holidays.NEW_YEAR.getRussianHolidaysTitle());
//                case WOMEN_DAY -> System.out.println(employee.getName() + " " + Holidays.WOMEN_DAY.getRussianHolidaysTitle());
//                case DEFENDERS_DAY -> System.out.println(employee.getName() + " " + Holidays.DEFENDERS_DAY.getRussianHolidaysTitle());
//
//            }
//        }
